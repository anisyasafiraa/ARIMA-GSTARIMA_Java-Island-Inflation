proc model data=WORK.Tr;
	...
	Banten = psi110*zlag1(Banten) + psi111*(0.198*zlag1(DIY)+0.206*zlag1(DKI_Jakarta)+0.231*zlag1(Jawa_Barat)+0.185*zlag1(Jawa_Tengah)+0.180*zlag1(Jawa_Timur));
...
OUT = GSTAR_paramKor OUTRESID OUTEST=Koefisien;
proc print Data=GSTAR_paramKor;
run;